...
buckshotIncendiary.speed = 6 + Mathf.random(12);
...
buckshotIncendiary.bulletHeight = 5 + Mathf.random(7);
...
buckshotExplosive.bulletHeight = 5 + Mathf.random(6);
